...
DV_NOTIS_BUNDLES = DV_LEGACY_DOWNLOADED / "notis-bundles"  # batched notis Word originals
DV_LEGACY_INDEX = DV_LEGACY_DOWNLOADED / "legacy-index.json"  # parsed direct-Word identity
