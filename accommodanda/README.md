...
```sh
uv run python -m accommodanda.build lawreview download lawpub  # the whole listing, newest first
uv run python -m accommodanda.build lawreview download lawpub --only lawpub/880
uv run python -m accommodanda.build lawreview parse            # incremental, the whole source
```
