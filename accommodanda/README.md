...
uv run python -m accommodanda.build remisser ai-analyze --update                        # every analysed ärende still open: pick up answers that arrived since
```
