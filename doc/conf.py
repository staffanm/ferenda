...
# -*- coding: utf-8 -*-
#
# Ferenda documentation build configuration file, created by
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.coverage', 'sphinx.ext.viewcode', 'sphinx.ext.intersphinx', 'sphinx.ext.graphviz']
...
project = 'Ferenda'
copyright = '2012-2015, Staffan Malmgren'
...
latex_documents = [
  ('index', 'Ferenda.tex', 'Ferenda Documentation',
   'Staffan Malmgren', 'manual'),
]
...
man_pages = [
    ('index', 'ferenda', 'Ferenda Documentation',
     ['Staffan Malmgren'], 1)
]
...
texinfo_documents = [
  ('index', 'Ferenda', 'Ferenda Documentation',
   'Staffan Malmgren', 'Ferenda', 'One line description of project.',
   'Miscellaneous'),
]
...
# don't document the data for class variables
