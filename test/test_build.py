...
def test_rebuild_after_commit_drives_the_right_stages(monkeypatch):
    ...
    monkeypatch.setattr(build, "cmd_generate",
                        lambda only=None, source=None, **kw: generated.append((only, source)))
    ...
    assert (generated == [
        ({str(layout.artifact("sfs", "1962:700"))}, "sfs"),
        ({str(layout.artifact("eurlex", "32024R2847"))}, "eurlex"),
        ({str(layout.artifact("begrepp", "Avtal"))}, "begrepp"),
        (None, "site"),
    ])
