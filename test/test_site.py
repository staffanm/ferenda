...
def test_facet_nav_omits_single_bucket_primary_axis():
    # a primary axis with one bucket is not navigable, so its heading + link are
    # dropped (HUDOC's lone 'Domar'); the secondary axis under it still shows
    view = {"levels": ["Dokumenttyp", "År"],
            "buckets": [{"key": "judgment", "label": "Domar", "slug": "judgment",
                         "count": 7, "children": [
    ...
    view["buckets"].append({"key": "decision", "label": "Beslut", "slug": "decision",
                            "count": 1, "children": [
                                {"key": "2024", "label": "2024", "slug": "2024",
