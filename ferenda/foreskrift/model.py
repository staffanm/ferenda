...
These stay in the vertical until a second source needs the same shape. At that
point, the shared part moves to ``lib`` (rule:second-use-goes-to-lib). The
artifact on disk (``to_artifact``)
