...
This is a near-verbatim fork of https://github.com/staffanm/patchit. It is
self-contained and uses only ``bisect``, ``re``, and ``collections``. One
documented fix allows a hunk header to omit a length of 1 (see
