...
* Notisfall (.xml): the source material represents notiser as zero-byte Word
  files with retained XML bodies. It has two forms: a
...
itself.
  ...
  python -m ferenda.dv.legacy FILE                 # one file -> artifact
  python -m ferenda.dv.legacy --index INDEX [--limit N]  # batch + report
"""
