"""Format adapters for historical förarbete corpora.
...
corpus uses retained source material. Each upstream stored its bodies in a
different format. This module turns each into the vertical's own
